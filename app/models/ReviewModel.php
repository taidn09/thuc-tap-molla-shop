...
class ReviewModel
{
    ...
    {
        if ($productId) {
            $select = "SELECT * FROM product_reviews, users WHERE productId = $productId AND product_reviews.userId = users.userId";
            return $this->db->getAll($select);
        }
        $select = "SELECT * FROM product_reviews, users WHERE product_reviews.userId = users.userId";
        return $this->db->getAll($select);
    }
